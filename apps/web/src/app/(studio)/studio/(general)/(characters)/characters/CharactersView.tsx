          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {characters.map((characters, index) => (
                <tr key={characters.name} className="border-b border-100 hover:bg-200 cursor-pointer" onClick={() => window.location.href = `/studio/characters/${characters.id}`}>                  <td className="px-2">
                    <Checkbox
