    ...
    <CommentBase
      ...
      outerContainer={
        <div className="mt-1 flex justify-end gap-x-2">
          ...
          <Button size="sm" onClick={post} disabled={!commentText}>
            Post
          </Button>
        </div>
      }
    >
      <div className="overflow-hidden rounded-md font-normal">
        <textarea
          ...
          className="text-foreground placeholder:text-muted-foreground h-fit w-full resize-none bg-transparent p-3 focus:outline-none focus:ring-0"
